...
- Published [abstract in Journal of Thoracic Oncology](https://www.jto.org/article/S1556-0864(23)00466-5/fulltext)
...
Transformation of electronic health record data to the OMOP Common Data Model, which is built on a foundation of standardized vocabularies and a simple patient-centric data model. This is done by in-house development of open-source ETL-tools, shared in the OHDSI-community. Data is extracted using our cohort extraction tool with  custom clinical phenotypes. 
...
This clinical decision support might improve standardization of treatment plans across similar patients and guide decisions for clinically more complex cases.  
...
- RADar project research lead: Pieter-Jan Lammertyn 
...
### RADar summer school 2023 

The RADar summer school 2023 offers participants the opportunity to tackle various practical implementation steps and challenges to facilitate final secondary use of data in their own organization.  

RADar offers its own expertise and tools that it has experienced in setting up its own automated data pipeline with the aim of gaining insights from data-driven innovation and research projects.   

 

The goal of the RADar summer school 2023 for participants is to execute practical like: 

- fetch data from multiple (hospital) databases 

- data pseudonimization 

- send data securely to a cloud environment 

- set up an ETL implementation 

- introduction to various OHDSI tools and RADar tools Riab®, KEUN®  

- creating mapping tables and storing them in OMOP CDM tables 

- perform analyses and train a logistic model 

 

The context of the exercises are starting from clinically relevant research questions and the exercises will be run through so that data can be extracted from source systems, prepared, harmonized, stored in OMOP CDM tables to be processed afterwards generating valuable insights. 

Participants will present their exercises and knowledge trajectory in front of the group on the 5th and last day of the summer school course to obtain a summer school certificate. 

 

PRACTICAL 

04/09-08/09, 5 day course at RADar, AZ Delta Rumbeke 

Interested to get a link to register? Apply via radar@azdelta.be   
